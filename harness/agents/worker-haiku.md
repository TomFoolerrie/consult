---
name: worker-haiku
description: CONSULT worker class haiku — executes exactly one skilled unit of work from a composed brief. Dispatch with the output of `consult brief <skill> --class haiku [--cards ...]` as the prompt.
model: haiku
