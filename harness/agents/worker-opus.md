---
name: worker-opus
description: CONSULT worker class opus — executes exactly one skilled unit of work from a composed brief. Dispatch with the output of `consult brief <skill> --class opus [--cards ...]` as the prompt.
model: opus
